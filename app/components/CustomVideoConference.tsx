...
export function CustomVideoConference({
  ...
  return (
    ...
    <div
      className="lk-video-conference flex-1 flex w-screen h-screen"
      {...props}
    >
      {isWeb() && (
        <LayoutContextProvider
          ...
          onWidgetChange={widgetUpdate}
        >
          <div className="lk-video-conference-inner flex w-full h-full overflow-hidden">
            {/* 🟣 Sidebar */}
            ...
            <div className="flex-1 flex  min-w-0 overflow-hidden">
              <div
                ...
                // className={`flex-shrink-0 transition-all duration-300 bg-[#09090b] text-white shadow-lg overflow-y-auto w-[250px] p-4 `}
              >
